/** * 左右插槽 cell, **************************************************** * slot
name="left" slot name="right"* **************************************************** */
<template>
  <div class="content" @click="click">
    <div class="left">
      <slot name="left">
        <VButtonIcon class="button-icon" :title="tolength(title, titleLength)">
          <template #left>
            <van-image
        ...
        <VButtonIcon class="button-icon" :title="tolength(subtitle, subtitleLength)">
          <template #left>
            <van-image
